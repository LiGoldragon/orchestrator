...
attempt_model() {
  ...
  ORCHESTRATOR_CODEX_PROVIDER_MODE=real \
    ...
    ORCHESTRATOR_AGENT_RUN_TIMEOUT_SECONDS="${ORCHESTRATOR_AGENT_RUN_TIMEOUT_SECONDS:-240}" \
    ORCHESTRATOR_BEAD_CLOSE_TIMEOUT_SECONDS="${ORCHESTRATOR_BEAD_CLOSE_TIMEOUT_SECONDS:-120}" \
    ORCHESTRATOR_MAIL_TIMEOUT_SECONDS="${ORCHESTRATOR_MAIL_TIMEOUT_SECONDS:-120}" \
